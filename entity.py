...
class Chicken:
    def __init__(self, scene, pos):
        ...
        self.modelNodePath = scene.addObject('chicken.egg', pos=pos, scale=(0.7, 0.7, 0.7), isActor=True, isGeneric=True, anims={'walk':'resources/generic/chicken-walk'})
        self.modelNodePath.loop('walk')
